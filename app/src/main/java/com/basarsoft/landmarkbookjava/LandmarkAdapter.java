...
import com.basarsoft.landmarkbookjava.databinding.RecyclerRowBinding;
...
public class LandmarkAdapter extends RecyclerView.Adapter<LandmarkAdapter.LandmarkHolder> {
    ...
    // xml baglama islemi burada yapılacak
    ...
    @Override
    // layoutun içerisinde göstermek istediğimiz verileri burda göstericez
    ...
    @Override
    // xml in kaç kez olusacagini gösterir
